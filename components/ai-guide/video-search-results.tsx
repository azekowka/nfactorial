...
import { AvatarImage, Avatar, AvatarFallback } from '@/components/ai-guide/ui/avatar'
import { CardContent, Card } from '@/components/ai-guide/ui/card'
import {
  Dialog,
  DialogContent,
  DialogDescription,
  ...
  DialogTitle,
  DialogTrigger
} from '@/components/ai-guide/ui/dialog'
import {
  Carousel,
  type CarouselApi,
  CarouselContent,
  ...
  CarouselNext,
  CarouselPrevious
} from '@/components/ai-guide/ui/carousel'
